      ...
      {activeTab === "systems" && (
        <div>
          <div className="mb-4 text-sm gaia-muted max-w-2xl">
            Labs systems are bigger playgrounds that live inside GAIA itself.
            They are meant to feel like &quot;mini apps&quot; you can grow over
            time (starting with Inventory).
          </div>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {/* Systems entries removed per request */}
          </div>
        </div>
      )}
        ...
        <div>
          <div className="mb-3 flex items-center justify-between gap-3">
            <div className="space-y-1">
              <p className="text-sm font-medium">Builds from Academy</p>
              <p className="text-xs gaia-muted max-w-xl">
                Every time you pass a concept in the Academy and attach a build
                link, it shows up here. Until then, you&apos;ll see a couple of
                demo entries so the layout isn&apos;t empty.
              </p>
            </div>
          ...
          {filtered.length === 0 ? (
            <div className="gaia-panel gaia-muted rounded-lg border p-6 text-center text-sm">
              ...
              <p>
                Finish a concept in the Academy (pass the quiz), then add a
                build link in the &quot;Build&quot; step to see it listed here.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
