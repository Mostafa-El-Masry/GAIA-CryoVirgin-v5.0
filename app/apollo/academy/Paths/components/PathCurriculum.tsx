      ...
      <header className="space-y-4 mb-8">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs sm:text-sm text-slate-600">
          ...
          <span className="inline-flex items-center gap-1">
            <span className="text-[13px]">📚</span> {levelLabel}
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="text-[13px]">⏱</span> {durationLabel}
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="text-[13px]">📅</span> Personal pace
          </span>
        </div>
      </header>
            ...
            return (
              <div
                ...
                className={`rounded-2xl border bg-white shadow-sm transition ${
                  isOpen
                    ? "border-sky-400 shadow-[0_10px_30px_rgba(15,23,42,0.12)]"
              ...
              >
                <button
                  ...
                  onClick={() =>
                    setOpenSection(isOpen ? null : course.section)
                  }
                >
                  ...
                  <div className="flex items-center gap-4 text-[11px] sm:text-xs text-slate-500">
                    ...
                    <span
                      className={`inline-flex h-6 w-6 items-center justify-center rounded-full border text-slate-500 text-sm ${
                        isOpen
