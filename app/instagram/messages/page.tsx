...
const mockConversations: Conversation[] = [
  { id: '1', username: 'friend_a', lastMessage: 'Hey, how are you?', avatar: 'https://via.placeholder.com/150/FF00FF/FFFFFF?text=FA' },
  { id: '2', username: 'friend_b', lastMessage: 'Did you see that post?', avatar: 'https://via.placeholder.com/150/FFFF00/000000?text=FB' },
  { id: '3', username: 'gaia_user', lastMessage: 'Thanks for the likes!', avatar: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=YOU' },
];
...
const MessagesPage: React.FC = () => {
  ...
  return (
    <main className={`relative min-h-screen ${spaceGrotesk.className} gaia-bg`}>
      <InstagramHeader />
      <div className="flex h-[calc(100vh-60px)]"> {/* Adjust height to account for header */}
        {/* Conversation List */}
            ...
            <>
              ...
              <div className="p-4 border-b border-gray-800 flex items-center">
                <Image
                  ...
                  className="rounded-full mr-3"
                />
                <h3 className="text-white font-semibold">{activeConversation.username}</h3>
              </div>
              {/* Message Display Area */}
              <div className="flex-grow p-4 overflow-y-auto">
                <p className="text-gray-500 text-center text-sm">Start of conversation with {activeConversation.username}</p>
              </div>
              {/* Message Input */}
