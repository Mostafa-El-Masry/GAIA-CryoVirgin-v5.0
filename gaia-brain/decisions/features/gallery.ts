...
export function getAutoBoxResult(
  ...
  if (!items.length) {
    return {
      ...
      label: "No Feature",
      description:
        "There are no media items yet. Add something to your Gallery to see a feature here.",
    };
  }
  ...
  if (pinnedBest) {
    return {
      ...
      description:
        "You pinned this memory as the current feature. Auto-box logic is paused for now.",
    };
  }
  ...
  if (thisWeekBest) {
    return {
      ...
      description:
        "A small nostalgia pull from this week across your timeline.",
    };
  }
